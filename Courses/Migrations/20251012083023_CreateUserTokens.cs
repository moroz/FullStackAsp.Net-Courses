...
namespace Courses.Migrations
{
    ...
    public partial class CreateUserTokens : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_tokens_created_at",
                table: "user_tokens",
                column: "created_at");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_tokens_valid_until",
                table: "user_tokens",
                column: "valid_until");

            migrationBuilder.Sql(
                "alter table user_tokens add constraint user_tokens_valid_until_constraint check (valid_until > created_at)");
        }
