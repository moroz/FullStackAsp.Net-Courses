...
namespace Courses.Migrations
{
    ...
    [Migration("20251101091730_AddDiscountCodeToEventPrices")]
    partial class AddDiscountCodeToEventPrices
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "price_rule_type", new[] { "base", "discount_code", "early_bird" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "price_type", new[] { "discount_fixed", "discount_percentage", "fixed", "percentage" });
            ...
            modelBuilder.Entity("Courses.Models.Event", b =>
                {
                    ...
                    b.ToTable("events", null, t =>
                        {
                            t.HasCheckConstraint("event_base_price_must_have_currency", "(base_price_amount is null) = (base_price_currency is null)");
                        });
                });
            ...
            modelBuilder.Entity("Courses.Models.EventPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<PriceRuleType>("RuleType")
                        .HasColumnType("price_rule_type")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_event_prices");

                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_event_prices_event_id");

                    b.HasIndex("DiscountCode", "EventId")
                        .IsUnique()
                        .HasDatabaseName("ix_event_prices_discount_code_event_id");

                    b.ToTable("event_prices", null, t =>
                        {
                            t.HasCheckConstraint("event_price_discount_code_check", "(discount_code is null) = (rule_type != 'discount_code')");

                            t.HasCheckConstraint("event_price_early_bird_check", "rule_type != 'early_bird' or valid_until is not null");
                        });
                });
            ...
            modelBuilder.Entity("Courses.Models.EventPrice", b =>
                {
                    b.HasOne("Courses.Models.Event", "Event")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_prices_events_event_id");
